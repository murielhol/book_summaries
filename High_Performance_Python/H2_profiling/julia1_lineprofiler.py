...
Source: ianozsvald
https://github.com/mynameisfiber/high_performance_python_2e/blob/master/02_profiling/julia1_lineprofiler.py
"""
import time
from profiling_utils import profile, mem_profile
